...
select count(*) as "Markets Numbers" from sales.markets;
...
select count(*) as "Customers Numbers" from sales.customers;
...
select count(*) as "Products Numbers" from sales.products;
...
-- Retrieve of all transactions in Mumbai city ( using subquerry )
SELECT * FROM sales.transactions as st
INNER JOIN sales.markets as sm
ON st.market_code = sm.markets_code
